...
def direct_audio(port, audio_source, mic):
    ...
    os.system(f'pactl load-module module-loopback source=ShareFlix_movie_sink.monitor sink=@DEFAULT_SINK@ sink_properties=device.description="ShareFlix_local_playback latency_msec=5"')
